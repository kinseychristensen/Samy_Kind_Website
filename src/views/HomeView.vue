...
<template>
  <div class="page-grid">
    <h1 class="page-title">Welcome!</h1>
      <img :src="samyPic" class="avatar page-avatar"/>
      <div class="avatar-intro">"Hello. My name is Samy Kind and this is my sister, Lucy. We are the first main characters that Mr. Nate ever 
